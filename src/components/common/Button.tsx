...
export function Button({
  ...
  const variants = {
    ...
    success:
      "bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:from-emerald-600 hover:to-emerald-600 focus-visible:ring-emerald-400 shadow-sm hover:shadow",
  };
