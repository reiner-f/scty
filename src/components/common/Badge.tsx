...
interface BadgeProps {
  ...
  size?: "sm" | "md" | "lg";
  /** Opțional: adaugă un efect subtil de puls pentru statusul 'pending' */
  animated?: boolean;
}
  ...
  return (
    <span
      className={classNames(
        ...
        // Estetică modernă (pill shape & tranziții)
        "rounded-full transition-colors duration-200 ease-in-out",
        // Clase dinamice extrase din dicționare
        config.wrapper,
        sizing.wrapper
      )}
    >
      <Icon 
        className={classNames(
          sizing.icon,
          // Adaugă o animație subtilă dacă prop-ul este activ și statusul e pending
          animated && status === "pending" ? "animate-pulse" : ""
        )} 
        strokeWidth={2.5} // Face iconițele puțin mai vizibile/groase
      />
